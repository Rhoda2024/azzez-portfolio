...
const RadishProjectOverview = () => {
  return (
    <div className="">
      <div className="m-auto max-w-[1500px] px-[2rem]">
        {" "}
        {/* ====project overview=== */}
        <div className="flex items-center justify-between pt-[6rem] pb-[5rem]">
          <div>
            <img src={img1} alt="" className="w-[600px]" />
          </div>

          <div className=" w-[650px] flex flex-col gap-[20px]">
            <p className=" font-Plus text-[40px] font-bold text-[rgba(0,0,0,1)] ">
              Project Overview
            </p>
            <p className=" font-Plus text-[32px] font-medium text-[rgba(0,0,0,1)]">
              Description
            </p>
            <p className="text-[rgba(133,133,133,1)] font-Plus text-[32px] font-medium ">
      ...
      {/* ==========problem========= */}
      <div className="bg-[rgba(210,185,218,1)] w-full py-[7rem] ">
        <div className=" max-w-[1400px] m-auto flex flex-col gap-[37px]">
          <div className="flex flex-col gap-[30px]">
            <p className=" font-Plus font-bold text-[36px] text-[rgba(34,2,45,1)] ">
              Problem
            </p>
            <p className=" font-lato font-normal text-[rgba(0,0,0,1)] text-[30px] ">
      ...
      <div className="max-w-[1500px] m-auto px-[2rem]">
        <div className=" flex flex-col gap-[32px] py-[8rem]">
          <p className="text-[40px] font-Plus font-bold text-[rgba(0,0,0,1)]">
            Challenges
          </p>
          <p className="text-[rgba(0,0,0,1)] font-Plus font-medium text-[24px]">
            The Challenges before designing
          </p>
          <div className="text-[32px] font-lato font-normal">
            {/*  */}
