...
const HealingKeyFeatures = () => {
  ...
  return (
    <div className="max-w-[1600px] m-auto px-[1rem] lg:px-[2rem]">
      <div>
        <p className="font-bold font-Plus text-[24px] sm:text-[40px] text-[rgba(34,2,45,1)] pb-[10px] ">
          Key features
        </p>
      </div>
      {/* =================== */}
        ...
        {features.map((feature, index) => (
          <div key={index}>
            <div className="flex flex-col gap-[10px]">
              <p className="text-[rgba(0,0,0,1)] font-Plus text-[18px] sm:text-[32px] font-bold ">
                {feature.header}
              </p>
              <p className="font-lato font-normal text-[16px] sm:text-[30px] ">
                {feature.subhead}
              </p>
              <div>
